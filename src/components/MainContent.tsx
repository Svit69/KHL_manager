  ...
  return (
    <>
      ...
      <div className="flex-1 bg-[#101010] relative">
        {/* Верхнее меню */}
        <div 
          className="sticky top-0 z-10 isolate bg-[#101010] border-b border-[#383838]"
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center">
        {/* Затемнение фона */}
        <div className="absolute inset-0 bg-[#101010] opacity-74"></div>
        
        {/* Прямоугольник со скругленными углами */}
        <div className="relative w-[600px] h-[400px] rounded-2xl bg-[#101010] border border-[#AFAFAF] overflow-hidden">
          {/* Фоновое изображение */}
          <div 
